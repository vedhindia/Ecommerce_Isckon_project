            ...
            while ($item = mysqli_fetch_assoc($result)) {
                ...
                ?>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6"
                                id="wishlist-item-<?php echo $item['wishlist_id']; ?>">
                                <div class="woo_product_grid no-hover">
                                    <span class="woo_pr_tag hot">Hot</span>
                                    <div class="woo_product_thumb">
                                        <img src="<?php echo $main_image; ?>" class="img-fluid"
                                    ...
                                    <div class="woo_product_caption center">
                                        ...
                                        <div class="woo_title">
                                            <h4 class="woo_pro_title"><a
                                                    href="product-detail.php?id=<?php echo $item['id']; ?>"><?php echo htmlspecialchars($item['name']); ?></a>
                                            </h4>
                                        </div>
                                        <div class="woo_price">
                                            <h6>₹<?php echo number_format($item['product_price'], 2); ?><span
                                                    class="less_price">₹<?php echo number_format($original_price, 2); ?></span>
                                            </h6>
                                        </div>
                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    class="woo_cart_btn btn_cart" title="Add to Cart">
                                                    <i class="ti-shopping-cart"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);"
                                                    onclick="removeFromWishlist(<?php echo $item['wishlist_id']; ?>)"
                                                    class="btn_save" title="Remove from Wishlist">
                                                    <i class="ti-trash"></i>
                                                </a>
                                            </li>
                                        </ul>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                showNotification(response.message || 'Failed to remove item',
                                    'error');
                            }
                        },
                        error: function(xhr, status, error) {
