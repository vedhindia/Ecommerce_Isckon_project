                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="toolbar toolbar-products">
                                    ...
                                    <div class="modes">
                                        <a class="modes-mode mode-grid" title="Grid" href="#"><i
                                                class="ti-layout-grid3"></i></a>
                                        <a class="modes-mode mode-list" title="List" href="#"><i
                    ...
                    if ($result && $result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $discount_price = $price * 0.9; // example 10% discount
                    ?>
                            <!-- Single Product -->
                                    ...
                                    <div class="woo_product_caption center">
                                        ...
                                        <div class="woo_title">
                                            <h4 class="woo_pro_title">
                                                <a
                                                    href="detail.php?id=<?php echo $row['id']; ?>"><?php echo $row['product_name']; ?></a>
                                            </h4>
                                        </div>
                                        <div class="woo_price">
