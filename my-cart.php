            ...
            <div class="container">
                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4 class="tbl_org_price">
                                                ₹<?php echo number_format($item['unit_price'], 2); ?></h4>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="tbl_pr_action">
                                                <h5 class="tbl_total_price">
                                                    ₹<?php echo number_format($item['subtotal'], 2); ?></h5>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                                    ...
                                    <li class="list-group-item d-flex">
                                        <span>Subtotal</span>
                                        <span
                                            class="ml-auto font-size-sm">₹<?php echo number_format($cart_data['total'], 2); ?></span>
                                    </li>
                                    <li class="list-group-item d-flex">
                                        <span>Tax</span>
                        ...
                        <a class="px-0 text-body" href="index.php"><i class="ti-back-left mr-2"></i> Continue
                            Shopping</a>
                    </div>
